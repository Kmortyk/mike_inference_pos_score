...
class SSDMetaArch(model.DetectionModel):
  ...
  def predict(self, preprocessed_inputs, true_image_shapes):
    ...
    # print("[kmortyk] print anchors")
    # for anch in predictions_dict['anchors']:
    #     print(anch)

    for prediction_key, prediction_list in iter(predictor_results_dict.items()):
      # print(f"[kmortyk] prediction_key {prediction_key} prediction_list {prediction_list}")
    ...
    # print("[kmortyk] return predictions dict")
